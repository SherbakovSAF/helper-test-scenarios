let state = {
    questions: [
        ...
        },
        {
            id: 28,
            question:
                "Вы видите  игрока, который в своей лавки установил цену за товар 411111111. Вы его предупредили. Он её поменял. Но через 10 минут, цена опять 411111111.",
                command: "/ban",
                minPunish: 1,
                maxPunish: 1,
            currentAnswerQuestion:
                "На сервере нет разделение между символами(4.000.000), поэтому символы с повторяющимися значениями выше 3 - обман зрения. Пример: 4002222 - обман, 4000222 - не обман.",
        },
        {
            id: 29,
            question:
                "Игрок на территории автобазара поставил лавку. После просьбы её убрать. Он Вам ничего не ответил.",
                command: "/kick",
            currentAnswerQuestion:
        ...
        },
        {
            id: 35,
            question:
                "Игрока грабят, когда он везёт бочки. В ответ на ограбление игрок вышел и начала стрелять по ним. Будет ли выдано наказание водителю нефтевоза?",
                command: "/jail",
                minPunish: 1,
                maxPunish: 100,
            currentAnswerQuestion:
